...
.. option:: -j, --max-concurrent-downloads= 
...
.. option:: --all-proxy-passwd= 

 Set password for :option:`--all-proxy` option.

.. option:: --all-proxy-user= 
...
.. option:: -x, --max-connection-per-server= 

 The maximum number of connections to one server for each download.
 Default: ``1``

.. option:: --max-file-not-found= 
 ...
 *AppleTLS* users should use the KeyChain Access utility to import the client
 ...
 To start aria2c use `--certificate= `.
...
.. option:: --https-proxy-passwd= 

 Set password for :option:`--https-proxy`.

.. option:: --https-proxy-user= 
...
.. option:: --ftp-proxy-passwd= 

 Set password for :option:`--ftp-proxy` option.

.. option:: --ftp-proxy-user= 
...
.. option:: --bt-prioritize-piece=head[=],tail[=]
 ...
 if ``head= `` is specified, pieces in the range of first SIZE bytes
 of each file get higher priority. ``tail= `` means the range of
...
.. option:: --bt-tracker-connect-timeout= 
...
.. option:: --metalink-language= 

 The language of the file to download.

.. option:: --metalink-location= [,...]
...
.. option:: --optimize-concurrent-downloads [true|false|:]
...
.. option:: --no-file-allocation-limit= 
...
.. option:: --socket-recv-buffer-size= 
